...
repo --name=scribus --baseurl=http://download.opensuse.org/repositories/home:/mrdocs/Fedora_14/ --includepkgs=scribus,libpodofo0_8_4
...
Miro
gnome-mplayer
-totem # Totem is replaced with gnome-mplayer, 8.4 M
gecko-mediaplayer
#gxine
...
gconftool-2 --direct --config-source=xml:readwrite:/etc/gconf/gconf.xml.defaults -s -t string /desktop/gnome/applications/browser/exec "/usr/bin/chromium-browser %s" > /dev/null
gconftool-2 --direct --config-source=xml:readwrite:/etc/gconf/gconf.xml.defaults -s -t string /desktop/gnome/applications/browser/exec "/usr/bin/chromium-browser %s" > /dev/null
gconftool-2 --direct --config-source=xml:readwrite:/etc/gconf/gconf.xml.defaults -s -t string /desktop/gnome/applications/browser/exec "/usr/bin/chromium-browser %s" > /dev/null
gconftool-2 --direct --config-source=xml:readwrite:/etc/gconf/gconf.xml.defaults -s -t string /desktop/gnome/applications/browser/exec "/usr/bin/chromium-browser %s" > /dev/null
...
--set /apps/panel/default_setup/general/applet_id_list -t list --list-type=string "[mintmenu,show_desktop,dockbarx,clock,systray,workspace_switcher]"
...
enabled=1
includepkgs=scribus,libpodofo0_8_4
EOF
