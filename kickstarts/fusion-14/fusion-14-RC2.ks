...
-brasero # remove duplicate burning app
...
gconftool-2 --direct --config-source=xml:readwrite:/etc/gconf/gconf.xml.defaults -s -t string /desktop/gnome/interface/gtk_theme Alliance > /dev/null
...
then
echo "no file present, downloading Alliance"
