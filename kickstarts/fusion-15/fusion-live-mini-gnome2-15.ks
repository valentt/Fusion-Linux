...
repo --name=fedora --mirrorlist=http://mirrors.fedoraproject.org/mirrorlist?repo=fedora-15&arch=$basearch --exclude=gnome-bluetooth-libs,nautilus,libgnomekbd,nautilus-extensions,gnome-screensaver
repo --name=updates --mirrorlist=http://mirrors.fedoraproject.org/mirrorlist?repo=updates-released-f15&arch=$basearch --exclude=gnome-bluetooth-libs,nautilus,libgnomekbd,nautilus-extensions,gnome-screensaver
